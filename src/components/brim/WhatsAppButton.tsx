...
export function WhatsAppButton() {
  ...
  const handleWhatsApp = () => {
    window.open(
      `https://wa.me/${whatsappNumber}?text=${encodeURIComponent("Hello! I'd like to know more about your LED Clocks.")}`,
      "_blank",
    );
  };
  ...
  return (
    <motion.button
      ...
      className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50 bg-[#25D366] text-white p-3 sm:p-4 rounded-full shadow-lg hover:shadow-xl transition-shadow group"
